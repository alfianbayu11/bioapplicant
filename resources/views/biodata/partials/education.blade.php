    ...
    <table class="w-full border-collapse border border-gray-300 rounded">
        ...
        <tbody id="education-tbody">
                    ...
                    <tr>
                        <td class="p-2 border border-gray-300">
                            <select name="educations[{{ $index }}][jenjang_pendidikan]"
                                ...
                                <option value="SMA/K"
                                    {{ $education['jenjang_pendidikan'] == 'SMA/K' ? 'selected' : '' }}>SMA/K</option>
                                <option value="D3" {{ $education['jenjang_pendidikan'] == 'D3' ? 'selected' : '' }}>
                                    D3</option>
                                <option value="S1/D4"
                                    {{ $education['jenjang_pendidikan'] == 'S1/D4' ? 'selected' : '' }}>S1/D4</option>
                                <option value="S2" {{ $education['jenjang_pendidikan'] == 'S2' ? 'selected' : '' }}>
                                    S2</option>
                                <option value="S3" {{ $education['jenjang_pendidikan'] == 'S3' ? 'selected' : '' }}>
                                    S3</option>
                            </select>
                        </td>
                        <td class="p-2 border border-gray-300">
            ...
            @else
                <tr>
                    <td class="p-2 border border-gray-300">
                        <select name="educations[0][jenjang_pendidikan]"
                            class="shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm w-full p-2.5 border border-gray-300 rounded">
                            <option value="">Pilih Jenjang Pendidikan</option>
                    ...
                    <td class="p-2 border border-gray-300">
                        <input type="text" name="educations[0][institusi]"
                            class="shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm w-full p-2.5 border border-gray-300 rounded"
                            placeholder="Nama Institusi Akademik">
                    </td>
                    <td class="p-2 border border-gray-300">
                        <input type="text" name="educations[0][jurusan]"
                            class="shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm w-full p-2.5 border border-gray-300 rounded"
                            placeholder="Jurusan">
                    </td>
                    <td class="p-2 border border-gray-300">
                        <input type="number" name="educations[0][tahun_lulus]"
                            class="shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm w-full p-2.5 border border-gray-300 rounded"
                            placeholder="Tahun Lulus">
                    </td>
                    <td class="p-2 border border-gray-300">
                        <input type="number" step="0.01" name="educations[0][ipk]"
                            class="shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm w-full p-2.5 border border-gray-300 rounded"
                            placeholder="IPK">
                    </td>
                </tr>
