                    ...
                    <div class="container mx-auto px-4 py-8">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="posisi_yang_dilamar" name="posisi_yang_dilamar"
                                value="{{ $biodata['posisi_yang_dilamar'] }}" readonly
                        ...
                        <div class="mb-4">
                            <label for="noKtp" class="block text-gray-700 text-sm font-medium mb-2">Nomor
                                KTP:</label>
                            <input type="text" id="noKtp" name="noKtp" value="{{ $biodata['noKtp'] }}" readonly
                                class="shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm w-full p-2.5 border border-gray-300 rounded">
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" id="tempatLahir" name="tempatLahir"
                                    value="{{ $biodata['tempatLahir'] }}" readonly
                                    class="shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm w-full p-2.5 border border-gray-300 rounded">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" id="tanggalLahir" name="tanggalLahir"
                                    value="{{ $biodata['tanggalLahir'] }}" readonly
                                    class="shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm w-full p-2.5 border border-gray-300 rounded">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="jenisKelamin" name="jenisKelamin"
                                value="{{ $biodata['jenisKelamin'] }}" readonly
                                class="shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm w-full p-2.5 border border-gray-300 rounded">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="alamatKtp" name="alamatKtp" rows="3" readonly
                                class="shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm w-full p-2.5 border border-gray-300 rounded">{{ $biodata['posisi_yang_dilamar'] }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center">
                                <input type="radio" id="placement_yes" name="placement" value="yes"
                                    {{ $biodata['placement'] == 'yes' ? 'checked' : '' }} disabled
                            ...
                            <div class="flex items-center">
                                <input type="radio" id="placement_no" name="placement" value="no"
                                    {{ $biodata['placement'] == 'no' ? 'checked' : '' }} disabled
                                    class="w-4 h-4 text-blue-500 border-gray-300">
